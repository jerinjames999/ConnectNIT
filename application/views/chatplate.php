        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <a href="<?php echo site_url();?>user/profile/<?php echo $_SESSION['user_id'];?>" class="customLink">
                        ...
                        <div class="row">
                            <?php foreach($users as $user):?>
                                ...
                                <div class="col-12 chater">
                                    <a class="chater customLink" href="<?php echo site_url();?>chat/user_chat/<?php echo $user['user_id'];?>">
                                        <div class="row ">
                                            <div class="col-3">
